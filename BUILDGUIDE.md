...
To setup an Fabric Warehouse with "NORTHWIND" (must be created with [case insensitive collation](https://learn.microsoft.com/en-us/fabric/data-warehouse/collation)) tables, use SQL Script: [createNorthwindFabricDw.sql](tools/testsql/createNorthwindFabricDw.sql).
